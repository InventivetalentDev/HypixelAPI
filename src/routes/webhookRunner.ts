...
function doPost(context: string, data: any, url: string, format: string, connection: Connection, targetId: number) {
...
export default function(pool: Pool): WebhookResult {
    ...
    let queryWebhooks = function queryWebhooks(context: string, cb: Callback) {
